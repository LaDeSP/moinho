...
function inserirParticipante(nome, cpf, tipo, id){
    pessoa = `
    <div class="col-md-4" id="`+id+`">
        <span href="#" class=" list-group-item list-group-item-action flex-column align-items-start">
            ...
            <br>
            <br>
            <button type="submit" class="btn btn-outline-danger" onClick="excluir(`+id+`)" > Excluir </button>
            <input style="display: none" value="`+id+`" type="number" name="participante_id[]" class="form-control">
        </span>
    </div>
    `;
    console.log(id);
