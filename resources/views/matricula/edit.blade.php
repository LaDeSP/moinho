...
<form onkeyup="verifica_submit('validate');" method= "POST" action="{{ route('matricula.update', $matricula->id) }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <br>
            <button id="submit" type="submit" class="btn btn-outline-success"> Salvar </button>
        </div>
    </div>
</form>
