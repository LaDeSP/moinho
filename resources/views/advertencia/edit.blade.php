        ...
        <div class="row">
            <div class="col-md-4">
                <label for="exampleFormControlInput1">
                    <?php echo Lang::get('validation.attributes.name'); ?> do participante
                        ...
                        <input type="text" name="participante_id" size="23" class="form-control" id="participante" value="{{$id}}" hidden="hidden" disabled> <!-- id da ocorrencia (ocorrencia.id) -->
                        <input type="text" name="nomeParticipante" size="23" class="form-control" id="ocorrencia_id" value=" <?php 
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" name="agressor" value="{{$advertencia->agressor}}" id="nome" size="23" class="form-control">
                </div>
                <div class="col-md-4">
                        <!-- Chamar Responsável -->
