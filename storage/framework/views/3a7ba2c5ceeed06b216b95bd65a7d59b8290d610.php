...
<?php $__env->startSection('content'); ?>
    ...
    <form method= "POST" action="<?php echo e(route('dados_inscricao.store')); ?>" enctype="multipart/form-data">
        ...
        <?php $__currentLoopData = $escola; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <option value="<?php echo e($school->id); ?>"> <?php echo e($school->nome_fantasia); ?> </option>
